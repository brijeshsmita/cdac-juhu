	...
	<body style="background-color:'cyan';font-family:'Comic Sans MS'"><!-- inline styling/css -->
		...
		<form action="LoginServlet" method="post">
			<table style="border: 2"><!-- attribute="value" -->
				...
				<tr>
					<td>Username:</td>
					<td><input type="text" name="username" required="required"/></td><!-- accept username for user -->
				</tr>
				<tr>
					<td>Password:</td>
					<td><input type="password" name="password" required="required"/></td><!-- accept password for user -->
				</tr>
				<tr>			
